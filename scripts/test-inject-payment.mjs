...
assert(inject.includes('handlePaymentPlaceOrderClick'), 'Place Order click handler should exist');
...
assert(inject.includes('stopPlaceOrderEvent'), 'credit Place Order should stop native handler after redirect');
